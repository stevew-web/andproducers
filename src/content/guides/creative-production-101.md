...
featured: true
download: "/downloads/creative-production-101-guide.pdf"
---

A clear, modern delivery lifecycle for marketing production teams.
...
| Stage | Owner | Stakeholders |
|-------|-------|-------------|
| Brief → Align | Producer / PM | Media, Legal, Creative, Brand |
| Build → Review | Creative production | Creative director |
| Approve → Sign off | Producer | All named approvers |
| QA → Certify | QA / Producer | None (process, not opinion) |
| Publish → Handoff | Producer | Trafficking / platform team |
